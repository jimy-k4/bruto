...
export function DocumentationEditor({
  ...
  return (
    <aside
      className="note-editor documentation-editor"
      style={
        editorStyle
      }
    >
              ...
              onDraftChange(
                {
                  ...
                  type: event
                    .target
                    .value as WorkspaceDocumentation['type'],
                },
              )
            }
          >
