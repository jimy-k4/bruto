  ...
  return (
    <>
      ...
      <div className="sidebar-section documentation-section">
        ...
        0 ? (
          <p className="sidebar-description documentation-empty">
            {t(
              'noDocumentation',
            )}
          </p>
          ...
          <div className="workspace-documentation-list">
            {workspace.documentation.map(
              (
                ...
                <div
                  className="workspace-documentation-item"
                  key={
                    documentation.id
                  }
                >
                  <div className="workspace-documentation-info">
                    <span className="workspace-documentation-type">
                      {getLocalizedDocumentationTypeLabel(
                        documentation.type,
                        t,
                      )}
                    </span>
                    ...
                    <span className="workspace-documentation-url">
                      {
                        documentation.url
                      }
                    </span>
